...
async function main() {
  ...
  const institutionsToInsert: (typeof institutions.$inferInsert)[] = [];
  ...
  let iitbId = institutionsToInsert.find(i => i.websiteDomain === "iitb.ac.in")?.id;
  let bitmId = institutionsToInsert.find(i => i.websiteDomain === "bitmesra.ac.in")?.id;
  ...
  const profileList = [
    { id: "prof_aarav", displayName: "Aarav Sharma", username: "aarav_sharma", bio: "Web Developer & Biryani enthusiast. Let's code!", college: iitbId, gender: "MALE", referralCount: 5, referredById: null },
    { id: "prof_sneha", displayName: "Sneha Patel", username: "sneha_patel", bio: "IIT Bombay CSE. Coffee and UI design is my life.", college: iitbId, gender: "FEMALE", referralCount: 3, referredById: null },
    { id: "prof_rohan", displayName: "Rohan Verma", username: "rohan_verma", bio: "Machine Learning geek. Gym & Anime lover.", college: iitbId, gender: "MALE", referralCount: 2, referredById: null },
    { id: "prof_ananya", displayName: "Ananya Iyer", username: "ananya_iyer", bio: "Electrical Engineering. Looking for someone to study with.", college: iitbId, gender: "FEMALE", referralCount: 0, referredById: "prof_aarav" },
    { id: "prof_vikram", displayName: "Vikram Singh", username: "vikram_singh", bio: "Aerospace major. Space is cool, match with me!", college: iitbId, gender: "MALE", referralCount: 0, referredById: "prof_aarav" },
    ...
    { id: "prof_tanya", displayName: "Tanya Kapoor", username: "tanya_k", bio: "Literature enthusiast", college: iitbId, gender: "FEMALE", referralCount: 0, referredById: "prof_sneha" },
    { id: "prof_neil", displayName: "Neil D'Souza", username: "neil_d", bio: "Gamer & coder", college: iitbId, gender: "MALE", referralCount: 0, referredById: "prof_rohan" },
    { id: "prof_rhea", displayName: "Rhea Sen", username: "rhea_sen", bio: "Biotech major", college: iitbId, gender: "FEMALE", referralCount: 0, referredById: null },
    { id: "prof_yash", displayName: "Yash Vardhan", username: "yash_v", bio: "UI Designer", college: iitbId, gender: "MALE", referralCount: 0, referredById: null },
    { id: "prof_diya", displayName: "Diya Mehta", username: "diya_m", bio: "Always reading a book", college: iitbId, gender: "FEMALE", referralCount: 0, referredById: null },
    { id: "prof_arjun", displayName: "Arjun Reddy", username: "arjun_r", bio: "Filmmaker & student", college: iitbId, gender: "MALE", referralCount: 0, referredById: null },
    { id: "prof_kiara", displayName: "Kiara Advani", username: "kiara_a", bio: "Fashion design & code", college: iitbId, gender: "FEMALE", referralCount: 0, referredById: null },
    { id: "prof_karan", displayName: "Karan Johar", username: "karan_j", bio: "Drama & Gossip club founder", college: iitbId, gender: "MALE", referralCount: 0, referredById: null }
  ];
