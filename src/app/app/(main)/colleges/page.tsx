...
import { Search, School, MapPin, Globe, ChevronLeft, ChevronRight, Sparkles, SlidersHorizontal } from "lucide-react";
    ...
    <main className="mx-auto flex w-full max-w-4xl flex-col min-h-screen pb-20 px-4 pt-6 gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed max-w-xl">
          Search and explore verified higher education institutions across India. Click any campus to view confessions, student discussions, and polls.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center border border-dashed rounded-3xl border-border bg-card/40 p-6 space-y-2">
          ...
          <h3 className="text-sm font-bold text-foreground">No colleges found</h3>
          <p className="text-xs text-muted-foreground max-w-xs">
            No campus matched your search "{search}". Try searching for another city, state, or AISHE code.
          </p>
        </div>
      )}
    </main>
