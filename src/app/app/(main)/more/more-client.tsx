  ...
  return (
    <div className="min-h-screen pb-24 text-foreground select-none max-w-2xl mx-auto px-4 pt-3 space-y-6">
      ...
      <div className="space-y-6">
        ...
        {/* ─── Official Social Channels (Clean Bottom Section) ─── */}
        <div className="space-y-2 pt-2">
          ...
          <div className="space-y-2">
            ...
            <a
              ...
              className="block p-3.5 rounded-2xl border border-border/70 bg-card/70 hover:bg-muted/40 hover:border-purple-500/40 transition-all group cursor-pointer shadow-xs"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 text-white shrink-0 group-hover:scale-105 transition-transform shadow-xs">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-semibold px-2 py-0.2 rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-2xl border border-border/70 bg-card/70 hover:bg-muted/40 hover:border-border transition-all group flex items-center justify-between cursor-pointer shadow-xs"
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="flex size-8 items-center justify-center rounded-lg bg-blue-600/15 text-blue-400 shrink-0 group-hover:scale-105 transition-transform">
