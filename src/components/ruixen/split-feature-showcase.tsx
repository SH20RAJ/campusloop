...
const DEFAULT_WORKFLOW_ITEMS = [
  ...
  "Hostel mess committee polls",
  "Society recruitments & auditions",
  "Hackathon team matching",
  "Course notes & solved PYQs",
  "Lost & found campus recovery",
  "Campus fest passes & updates",
];

export function SplitFeatureShowcase({
  leftTitle = "Conversations that stay in context.",
  leftDescription = "Discuss course doubts, hostel news, and fest gossip with real-time threads, presence indicators, and verified peer reactions.",
  rightTitle = "Your campus pulse on autopilot.",
  rightDescription = "From exam alerts to club recruitments, everything happening across campus is organized in one live chronological pulse.",
  workflowItems = DEFAULT_WORKFLOW_ITEMS,
  className,
            ...
            <div className="flex items-center justify-center self-center">
              ...
              >
                {workflowItems.map((label, i) => {
                  const center = Math.floor(workflowItems.length / 2);
