...
export const DEGREE_OPTIONS: DegreeOption[] = [
  ...
  {
    code: "Dual Degree",
    name: "Integrated Dual Degree (B.Tech + M.Tech/MBA)",
    level: "OTHER",
    durationYears: 5,
  },
...
export const BRANCH_OPTIONS: BranchOption[] = [
  ...
  },
  {
    ...
    slug: "architecture-and-urban-planning",
    category: "DESIGN",
    icon: "🏛️",
  },
  {
  ...
  {
    name: "Medicine & Clinical Surgery (MBBS)",
  ...
  {
    name: "Commerce & Chartered Accountancy",
    slug: "commerce-and-accounting",
    category: "BUSINESS",
    icon: "📊",
  },
  {
    name: "Humanities, Literature & Psychology",
    slug: "humanities-and-psychology",
    category: "ARTS",
    icon: "📚",
  },
  ...
  // ─── Core engineering disciplines ───
  {
    ...
    slug: "production-and-industrial-engineering",
    category: "TECH",
    icon: "🏭",
  },
  {
  ...
  },
  {
    ...
    slug: "aerospace-and-aeronautical-engineering",
    category: "TECH",
    icon: "✈️",
  },
  ...
  {
    name: "Ocean Engineering & Naval Architecture",
    slug: "ocean-engineering-and-naval-architecture",
    category: "TECH",
    icon: "⚓",
  },
  ...
  {
    name: "Energy & Renewable Engineering",
    slug: "energy-and-renewable-engineering",
    category: "TECH",
    icon: "🔋",
  },
  ...
  {
    name: "Microbiology & Life Sciences",
    slug: "microbiology-and-life-sciences",
    category: "SCIENCE",
    icon: "🦠",
  },
  ...
  {
    name: "Statistics & Actuarial Science",
    slug: "statistics-and-actuarial-science",
    category: "SCIENCE",
    icon: "📉",
  },
  ...
  { name: "Film, Media & Performing Arts", slug: "film-and-performing-arts", category: "ARTS", icon: "🎬" },
  {
    ...
    slug: "sociology-and-political-science",
    category: "ARTS",
    icon: "🏛️",
  },
  ...
  // ─── Business & services ───
  {
    ...
    slug: "marketing-and-business-analytics",
    category: "BUSINESS",
    icon: "📣",
  },
  {
  ...
  { name: "Tourism & Travel Management", slug: "tourism-and-travel", category: "BUSINESS", icon: "🧳" },
  {
    ...
    slug: "agriculture-and-allied-sciences",
    category: "SCIENCE",
    icon: "🚜",
  },
...
export function getBranchOptionsForDegree(degreeCode?: string): BranchOption[] {
  ...
  if (upper.includes("ARCH")) {
    matched = all.filter((b) => b.category === "DESIGN" || b.slug === "civil-and-structural-engineering");
...
export function getBranchIcon(branchName?: string | null): string {
  ...
  if (lower.includes("comp") || lower.includes("cse") || lower.includes("mca") || lower.includes("it"))
    return "💻";
